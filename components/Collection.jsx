                ...
                <div className="flex flex-col justify-start items-center px-5  ">
                  ...
                  <div className="relative w-full overflow-hidden rounded-xl ">
                    <Image
                      ...
                      className="pointer-events-none rounded-xl group-hover:scale-110 overflow-hidden select-none transition duration-500"
                    />
                  </div>
                  {/* time and price */}
                  ...
                  <button className="bg-secondary rounded-xl font-medium text-[18px] py-[0.5px] w-[40%] mb-2 text-white hover:bg-secHover hover:text-white  transition-colors duration-300 ease-in-out ">
                    <a
                      href={`https://api.whatsapp.com/send?phone=385995163294&text=I%20want%20to%20rent%20${name}%20for%20a%20day`}
                    >
                      Rent
                    </a>
                  </button>
